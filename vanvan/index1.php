...
<head>
    ...
    <link rel="stylesheet" href="dmodestyle.css">
...
<body id="body">
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="feature">
                    ...
                    <h3><?php echo $lang['top-comment'] ?><span class="yl"><?php echo $lang['top-comment2'] ?></span>
                    </h3>
    ...
    <label class="switch">
            <input type="checkbox" id="toggle" <?php if($_COOKIE["theme"] == "dark") { echo "checked"; }?>>
