    ...
    if(!$_SESSION['username']) {
        ...
        if(isset($_POST['update'])) {
            ...
            if(mysqli_num_rows($result1) == 1) {
                $van_id = mysqli_query($conn,"UPDATE rent SET van_id  = '$opvan' WHERE cus_name = '$flname'");
